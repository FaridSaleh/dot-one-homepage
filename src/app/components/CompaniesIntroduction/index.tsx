  ...
  return (
    ...
    >
      <div className='mx-auto max-w-[1224px] flex items-center justify-center gap-[35px]'>
        <div
          className={`mb-[41px] transition-all duration-1000 ${hasReachedComponent ? 'translate-x-0' : 'translate-x-1/2'}`}
        >
          <Pattern3Logo className='w-[272px] h-[993px]' />
        </div>
        <div
          className={`flex-1 h-[952px] mt-[40px] transition-all rounded-[40px] overflow-scroll bg-[#f5f5f5] p-6 duration-1000 ${hasReachedComponent ? 'translate-x-0' : '-translate-x-1/2'}`}
        >
